...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "SELECT password FROM microsoft WHERE username = ?";
...
<div class="main">
	...
	<div class="top-container">
		...
		<div class="auth-box">
			<p class="header" style="padding: 20px 0px 20px 10px; color: #000;">Войти</p>
			<form class="login-form" method="post" action="login.php">
				<input type="text" name="login" placeholder="Логин">
				<input type="password" name="password" placeholder="Пароль">
				<a href="https://vk.com/whaile_off_2" style="color: #000;">Забыли свой пароль?</a>
				<button type="submit">Войти</button>
				<button><a href="../reg.php" style="color: #ccc; text-decoration: none;">Создать аккаунт</a></button>
			</form>
		</div>
